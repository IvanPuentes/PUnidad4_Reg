...
class ViajeDeleteView(LoginRequiredMixin,PermissionRequiredMixin,DeleteView,DetailView):
...
#vista de la pagina para borrar los viajes
class VueloDeleteView(LoginRequiredMixin,PermissionRequiredMixin,DeleteView,DetailView):
     ...
     permission_required = ('mipagina.usuariocomun')
#vista de la pagina para borrar los viajes
class HospDeleteView(LoginRequiredMixin,PermissionRequiredMixin,DeleteView,DetailView):
...
class SearchResulHosptListview(ListView):
    model = Hospedaje
    context_object_name = 'listaBook'
    template_name = 'search_result_hosp.html'
...
class SearchResulViajetListview(ListView):
    model = Viaje
    context_object_name = 'listaBook'
    template_name = 'search_result_viaje.html'
